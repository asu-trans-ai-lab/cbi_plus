...
REGISTRY = [
    ...
    dict(name="flow_tensor_demo", script=None,
         checks=[("tucker_price_of_rank.csv", "mae_kmh", "min", 0.0, None)],
         figures=["figures/flow_tensor_modes.png"],
         note="FTT engine artifacts; regenerate via cbi_pipeline.flow_tensor"),
